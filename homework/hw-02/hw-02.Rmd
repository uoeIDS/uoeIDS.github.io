...
a. Copy the above code to create the data visualisation. Describe the overall _shape_ of the histogram. What does this suggest about the _structure_ of the age distribution of the runners? You may calculate some simple summary statistics to support your comments. (**3 pts**)
