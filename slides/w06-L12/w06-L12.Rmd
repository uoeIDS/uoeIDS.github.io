...
ggplot(data = df, mapping = aes(x=x, y=y)) +
  ...
  geom_point(data = df_point, mapping = aes(x=x,y=y_M1), col="red", pch="X",cex=10)
```
...
ggplot(data = df, mapping = aes(x=x, y=y)) +
  ...
  geom_point(data = df_point, mapping = aes(x=x,y=y_M2), col="red", pch="X",cex=10)
```
]
