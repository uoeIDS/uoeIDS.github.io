...
## `summarise` to compute the average height
...
- Ps. R 4.1.0 introduced a native pipe operator, `|>`. The behaviour of the native pipe is by and large the same as that of the `%>%` pipe provided by the magrittr package.
