...
- Look through lab sheet 8. Labs tomorrow last chance to discuss with tutors. See marking criteria on lab sheet 9. 
- Lecture next Tuesday will be projects Q&A. Send questions!
- Application exercise and interactive R tutorial uploaded to website.
...
.center[
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img/Gallup_COP.png")
```
]

.footnote[
.midi[
Source: Gallup. [World Less Than Satisfied With Climate Efforts](https://news.gallup.com/poll/405215/climate-efforts-falling-short-across-globe.aspx), 22 Nov 2022.
]
]
