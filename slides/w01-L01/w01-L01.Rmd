...
```{r, echo=FALSE,out.width="15%", out.height="20%",fig.cap="Ozan / Cecilia",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("img/people/Ozan.jpg", "img/people/cecilia.jpg"))
```
...
**Q: What if I missed the lecture for some reason?**
A: Lectures will be recorded and shared `r emoji::emoji("sweat_smile")`.
]
...
knitr::include_graphics("img/ppdac.png")
```
Image Credit: [PPDA - The Statistical Method, MacKay and Oldford (2000)](https://www.statsref.com/HTML/statistics__statistical_analys.html)
...
.center[
.large[
[fringe-finder-project](https://izr94x-yijia-yang.shinyapps.io/fringe-finder/)
]
]

```{r echo=FALSE, out.width="65%"}
knitr::include_graphics("img/fringe_price_box.png")
```
...
5. Use the **basics of Git and GitHub** for the purpose of code **collaboration** and **reproducibility**.
]
...
- **Mondays:**
  ...
  - Lecture at 13:10-14:00, 1.15 - Larch Lecture Theatre - Nucleus.
- **Tuesdays:**
  - Quiz deadline from the previous week.
- **Wednesday:**
  - Lecture at 11:10-12:00, 1.15 - Larch Lecture Theatre - Nucleus.
  - Student Q&A session at 12:10-13:00, JCMB 6201.
  - New quiz released (starting week 2).
- **Thursday:**
  - Release of workshop material.
- **Fridays:**
  - Labs, 9:00 - 16:00 over 4 time slots: in G.09 - Teaching Studio - Murchison House
  - Check your timetable to attend the one you have been assigned to and bring your laptops!
  - If you have issues on workshop hours like clash or something else, let us know asap!
...
- We will be using RStudio for programming and Git/GitHub for teamwork and version control.
...
- **Student hour (Q&A session)** on Wednesday - I will provide additional support.

- **labs** - you will be able to get help from the tutors in the labs.

- **EdStem** - post here for help from us or your peers
...
- Go here for:
  ...
  - course marks
  - links to join EdStem and course website
...
## Course operation resources - EdStem

- For all course content related questions, a new system replacing Piazza
- Not only ask **but** also answer
...
- 5-7 multiple choice questions, some requiring a bit of coding, some conceptual and visual based exercises, some experimental and reflective style ones.
- **Tip:** Read the instructions carefully and don't leave it until the last minute!
- Submission:
  - `Assessment` > `Weekly Quizzes` via Learn-Ultra platform
...
**In-class test** (10%)
- **When**: During lecture, Wednesday 14 October, 11:10-12:00 (week 4).
- **Where**: 1.15 - Larch Lecture Theatre - Nucleus and Lecture Theatre B - JCMB.
- **Duration**: 20–30 minutes (details TBC), followed by lecture or not!
- Complete on Learn, using your laptops.
- Closed book and invigilated; no notes or internet access.
- Attendance will be taken, please bring your student ID.
...
- **Release**: Before Fridays, weeks 5, 8.
- **Deadline**: Fridays at 16:00, weeks 6 & 9.
- Work on them individually, based on HW template.
...
- How are you graded:
  - A team presentation.
  - A write-up of your investigation, with a certain word count.
...
Please read the [University guidance on GenAI](https://information-services.ed.ac.uk/computing/comms-and-collab/elm/guidance-for-working-with-generative-ai) and our assessment oriented instructions. 
...
- We know that GenAI is not going anywhere, but developing foundations of DS and some statistical thinking is our main goal here.  
- DS as a field is already under a big impact of GenAI
- [Cognitive offloading](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5082524): over-use of generative AI can negatively affect your learning
- **attempt first** is the key for developing a good habit on responsible use.

what you will get;

- **Honest and transparent communication about use of GenAI**
- Specific instructions about exploring some tasks with GenAI, I call it as **GenAI playground items** to support your learning

---

## Use of Generative-AI in this course

Academic integrity is an underlying principle. All submitted work is expected to be your own.
...
- Please ensure that you do not input direct exercise questions into the AI prompts. Do not copy and paste the outputs generally, for your own learning.
...
**Final Project**:
- AI tools (e.g., ELM, chatGPT) should **not be used to generate content** for this assessment. However, you are allowed to use these tools to identify ideas, help organize your thoughts, and plan your assessment. 
...
- Relying on GenAI tools for coding or simply copy-pasting their output will limit your ability to learn and develop your coding skills. If you used a GenAI tool to get help with a coding task, make sure you type out the solution (after having fully understood what it does) instead of copy-pasting the output.
...
- **If you use AI software, you must acknowledge its use in your submission.** [Here you can find examples of acknowledgements, important caveats](https://information-services.ed.ac.uk/computing/comms-and-collab/elm/generative-ai-guidance-for-students/using-generative) (no need to list the prompts and outputs used, unless it is suggested speficially).
- Some Examples: 
  - "I used GPT 5 via ELM to check grammar and spelling throughout my assignment."
  - "I used ChatGPT to correct the grammar and help me improve the clarity of my writing (no copy-pasting of entire sentences)."
...
- **EdStem** for course content, logistics, etc. discussion on the course discussion forum

- **Student hour (Q&A session)** after Wednesday lecture at 12.10-13.00, JCMB 6201. Optional, drop-in if you have any questions.

- **MathsBase** for drop-in support from a tutor, good to check their timetable. 

- ~~Email~~ **EdStem private messages**: for questions _only_ about personal matters (e.g. illness, concessions).

- Most importantly, ask questions! No need to be shy, we are here to help, not to judge your questions. 

---

.center[
.large[
Are you with me for that journey ?
]
]

```{r echo=FALSE, out.width="50%",fig.align='center'}
knitr::include_graphics("img/error_meme.jpeg")
```
