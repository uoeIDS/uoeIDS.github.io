...
## Ways of recangular data may be stored
...
`r emo::ji("down_arrow")` You may need to install specialised R packages to read data from a specific format
...
- Instead, click the clipboard button (`r emo::ji("clipboard")`) to copy the code into yout editor.
...
- .small[FYI, Battersea underground sation opened in 20-SEP-2021.]
---
