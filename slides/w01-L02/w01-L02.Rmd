...
- **Packages** are the fundamental units of reproducible R code. They include reusable R functions, the documentation that describes how to use them, and get some help when we need<sup>1</sup>. 

- In recent shared information, there are 25098 available R packages available on **CRAN** (the Comprehensive R Archive Network)<sup>2</sup>
...
- We will use GitHub as a platform for sharing course materials (main course management!) and collaboration on your projects. 
]
...
Creating a new repository:
1. Install homebrew https://brew.sh/ (copy and paste the code in the link into the terminal)
  - Check the last few printed lines: it will ask you to copy-paste in the terminal three lines of code that are part of the installation process.
