...
**TEAM MEMBERS 2+:** 
The following steps will ensure that you have your own copy of today's lab worksheet and maintain all of the communication between RStudio and GitHub so that you can attempt any outstanding exercises on your own time in your own version of the worksheet.

-   Ensure that you pull any further changes from the collaborative repository.
-   Log into GitHub and click on the green button to create a new blank repository with a suitable name. Note, do not clone the repository from team member 1!
-   Copy the HTTPS URL of your personal repository.
-   In RStudio, open the file _.git/config_ and replace the URL of the "origin" to your personal GitHub repository you have just created.
-   Save this file. (You may be asked to restart RStudio depending on your system.)
-   Finally, go to the Git pane and click on push _Push_. The message in the pop-up should mention something about creating a new branch. Go to your repository on GitHub and your files from today's lab should be there.
