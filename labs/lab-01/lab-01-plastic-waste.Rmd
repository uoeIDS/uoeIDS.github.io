...
Create a new repository on GitHub and clone today's lab worksheet from [https://github.com/uoeIDS/lab-01-worksheet](https://github.com/uoeIDS/lab-01-worksheet). To remind you of the step:

-    Go to *Your repositories* in your GitHub account and then click on the *New* button.

-    Click on *Import a repository* and type the URL of today's lab worksheet: [https://github.com/uoeIDS/lab-01-worksheet](https://github.com/uoeIDS/lab-01-worksheet)
...
First, open the R Markdown document `lab-01.Rmd`, change the author to your name and then *Knit* it. Make sure that it compiles without errors. Remember to periodically keep your version control up to date by staging and committing any substantial changes, and push them to GitHub.
...
We don't expect you to complete all of the exercises within the time reserved for the live workshop.
...
Once you're done, check to make sure your latest changes are on GitHub. <!-- and all your code is inside the .md file (created by pressing "knit").-->
