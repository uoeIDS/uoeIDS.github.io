...
- You will need to complete an evaluation of the input of your teammates. This is to check that everyone contributed equally. This will be used to calculate an individual mark for each team member, so that it reflects their contribution to the project.

- Note: the peer-evaluation score will be based on *WebPA*. This is a transparent system for assigning individual marks, based on each student's contribution to the group; you can find out more, together with a worked example [here](https://webpaproject.lboro.ac.uk/WorkedExample). The peer-evaluation score calculated by WebPA will affect 30% of the report mark, multiplicatively. 

- If you do not completethis peer feedback for all members of your team, you will receive a penalty of 20% off your mark. 
