...
- Open your repository page on Github; check it's your repository by making sure the username shown at the top-left of the page it's yours, not the course's one (`uoeIDS`). Click the green 'Code' button and copy the URL given under HTTPS (you can also check this is the correct repository because it should include your username, not the course's one).
...
It is important to commit and push your work regularly. Throughout future workshops you will see the icons  `r emoji::emoji("white_check_mark")` `r emoji::emoji("arrow_up")` as a reminder to go through the above commit/push steps.
