...
We recommend running the first command shown in the _command line_ (not the R console): 
...
Follow the same instructions as member 3. Begin by attempting to ⬆️ _Push_ your changes, which will result in an error message indicating that your personal version is behind the version on GitHub. Then:
...
<!-- It is now your turn to follow the above procedure. First attempt to ⬆️ _push_ your changes to get the error message. Then ⬇️ _pull_, find and resolve the merge conflict, 🧶 _knit_, ✅ _commit_ and finally ⬆️ _push_ your changes. -->
...
Although you have contributed your name to the author, you have not yet had the chance to experience a merge conflict -- it is now your turn!
...
Everybody, 🧶 _knit_, ✅ _commit_ and ⬆️ _push_ any remaining changes to your group's shared repository on GitHub. In doing so, ensure that you resolve any merge conflicts.
