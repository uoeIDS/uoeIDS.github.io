...
Our goal is to see two different types of merges: first, we will see a type of merge that git cannot figure out on its own how to do on its own (a **merge conflict**) and requires human intervention, then another type of where that git can figure out how to do without human intervention.
